...
export const puzzleCollectionsMock: PuzzleCollection[] = [
  {
    ...
    description:
      'Соберите пазл, проходя сценарии безопасных сделок.',
    ...
    reward: {
      ...
      description:
        'Скидка на одно продвижение объявления.',
    },
  },

  {
    ...
    description:
      'Разберитесь в схемах мошенничества с доставкой.',
    ...
    reward: {
      ...
      description:
        'Одно бесплатное поднятие объявления.',
    },
  },

  {
    ...
    description:
      'Научитесь отличать настоящие страницы от поддельных.',
    ...
    reward: {
      ...
      description:
        'Скидка на следующую Авито Доставку.',
    },
  },
