...
export const fakeDeliveryScenario: TrainingScenario = {
  ...
  description:
    'Сценарий с поддельной страницей оплаты',
  ...
  timeline: [
...

    {
      ...
      senderId: 'buyer',
      text:
        'Отлично. Я уже оплатил доставку. Перейдите по ссылке и получите деньги.',
      delayMs: 900,
    },
      ...
      options: [
        {
          ...
          isCorrect: false,
          feedback:
            'Не переходите по ссылкам для получения оплаты.',
        },
        {
          id: 'choice-2-answer-2',
          text:
            'Я проверю оплату только внутри приложения.',
          isCorrect: true,
          feedback:
            'Верно. Все операции необходимо проверять внутри приложения.',
        },
        {
          id: 'choice-2-answer-3',
          text:
            'Пришлите ссылку ещё раз, эта не открывается.',
          isCorrect: false,
        },
      ],
    },
